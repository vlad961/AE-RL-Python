...
NSL_KDD_FORMATTED_BALANCED_TRAIN_PATH = os.path.join(DATA_FORMATTED_DIR, "balanced_training_data.csv")
NSL_KDD_FORMATTED_BALANCED_TEST_PATH = os.path.join(DATA_FORMATTED_DIR, "balanced_test_data.csv")
